...
$(function(){var lang={ru:{more:"Больше информации",minimize:"Свернуть",readmore:"Читать дальше"},en:{more:"More info",minimize:"Minimize",readmore:"Read more"}}
var currentLang=document.querySelector('html').getAttribute('lang');var prev=$(document).width(),br=992,ww=$(window).width();var galleryTop=new Swiper('.gallery-top',{effect:"fade",spaceBetween:10,loop:true,preventInteractionOnTransition:true,pagination:{el:'.swiper-pagination',clickable:true},autoplay:{delay:3000,},});var photoThumbs=new Swiper('.photo-gallery',{spaceBetween:28,centeredSlides:false,slidesPerView:'auto',touchRatio:0.2,loop:true,slideToClickedSlide:false,preventInteractionOnTransition:true,noSwipingSelector:'a',navigation:{nextEl:'.photo-next',prevEl:'.photo-prev',},});var videoThumbs=new Swiper('.video-gallery',{spaceBetween:25,centeredSlides:true,slidesPerView:'auto',touchRatio:0.2,loop:true,slideToClickedSlide:false,preventInteractionOnTransition:true,noSwipingSelector:'a',navigation:{nextEl:'.video-next',prevEl:'.video-prev',},});var salonsGal=new Swiper('.salons-carousel',{slidesPerView:"auto",spaceBetween:30,initialSlide:1,centeredSlides:false,allowSlidePrev:false,allowSlideNext:false,breakpoints:{544:{allowSlidePrev:true,allowSlideNext:true,centeredSlides:true,spaceBetween:20},768:{spaceBetween:20,loop:true,slidesPerView:3,centeredSlides:true,initialSlide:0},992:{allowSlidePrev:true,allowSlideNext:true,centeredSlides:true,spaceBetween:20,}}});var licensesGal=new Swiper('.licenses-carousel',{slidesPerView:4,spaceBetween:30,breakpoints:{992:{allowSlidePrev:true,allowSlideNext:true,spaceBetween:20,slidesPerView:"auto",centeredSlides:true,initialSlide:1,}},navigation:{nextEl:'.licenses-carousel .swiper-button-next',prevEl:'.licenses-carousel .swiper-button-prev',},});var mastersOfSaloCarousel=new Swiper('.masters_of_salon',{slidesPerView:4,spaceBetween:30,loop:false,navigation:{nextEl:'.salon_team .swiper-button-next',prevEl:'.salon_team .swiper-button-prev',},breakpoints:{992:{slidesPerView:1,spaceBetween:20,}},});var sliders=[];$('.mobile_master_slider').each(function(index,element){$(this).addClass('s'+index);var slider=new Swiper('.s'+index,{slidesPerView:"auto",spaceBetween:20,initialSlide:0,centeredSlides:true,loop:true,navigation:{nextEl:'.mobile_master_slider .swiper-button-next',prevEl:'.mobile_master_slider .swiper-button-prev',}});sliders.push(slider);});var testimMobileSlider=new Swiper('.testim_mobile_slider',{slidesPerView:"auto",spaceBetween:20,initialSlide:1,centeredSlides:true,allowSlidePrev:true,allowSlideNext:true,loop:true,});var photoWorksCarousel=new Swiper('.photo_works_slider .swiper-container',{slidesPerView:4,spaceBetween:30,loop:true,navigation:{nextEl:'.photo_works_slider .swiper-button-next',prevEl:'.photo_works_slider .swiper-button-prev',},breakpoints:{992:{allowSlidePrev:true,allowSlideNext:true,spaceBetween:20,slidesPerView:"auto",centeredSlides:true,initialSlide:1,}},});var aboutGal=new Swiper('.about-us-slider',{spaceBetween:30,navigation:{nextEl:'.about-us-slider .swiper-button-next',prevEl:'.about-us-slider .swiper-button-prev',},});var singleSaloneGal=new Swiper('.sinlge-salon-gallery',{spaceBetween:30,slidesPerView:4,loop:false,navigation:{nextEl:'.sinlge-salon-gallery .swiper-button-next',prevEl:'.sinlge-salon-gallery .swiper-button-prev',},breakpoints:{768:{slidesPerView:2},460:{slidesPerView:1}}});var articleCarousel=new Swiper('.articles-slider .swiper-container',{spaceBetween:30,loop:false,slidesPerView:3,navigation:{nextEl:'.articles-slider .swiper-button-next',prevEl:'.articles-slider .swiper-button-prev',},breakpoints:{992:{slidesPerView:2,spaceBetween:20},767:{allowSlidePrev:true,allowSlideNext:true,spaceBetween:20,slidesPerView:"auto",centeredSlides:true,initialSlide:1,loop:true,}},});var salonMediaCarousel=new Swiper('.salon_media_slider .swiper-container',{spaceBetween:30,loop:false,slidesPerView:2,navigation:{nextEl:'.salon_media_slider .swiper-button-next',prevEl:'.salon_media_slider .swiper-button-prev',},breakpoints:{576:{spaceBetween:10,loop:true,slidesPerView:1,centeredSlides:false,initialSlide:0},768:{spaceBetween:20,loop:true,slidesPerView:3,centeredSlides:false,initialSlide:0},992:{allowSlidePrev:true,allowSlideNext:true,spaceBetween:20,slidesPerView:"auto",centeredSlides:true,loop:true,}},navigation:{nextEl:'.swiper-button-next',prevEl:'.swiper-button-prev',}});var salonPreviewSlider=new Swiper('.salon_preview_slider',{slidesPerView:1,loop:true,navigation:{nextEl:'.salon_preview_slider .swiper-button-next',prevEl:'.salon_preview_slider .swiper-button-prev',},});var brandsCarousel=new Swiper('.brands_slider .swiper-container',{slidesPerView:'auto',spaceBetween:30,loop:true,navigation:{nextEl:'.brands_slider .swiper-button-next',prevEl:'.brands_slider .swiper-button-prev',},});var mediaVideoPhotoSlider=new Swiper('.media_gallery',{slidesPerView:2,loop:false,navigation:{nextEl:'.media_gallery .swiper-button-next',prevEl:'.media_gallery .swiper-button-prev',},spaceBetween:30,breakpoints:{992:{allowSlidePrev:true,allowSlideNext:true,spaceBetween:20,slidesPerView:"auto",centeredSlides:true,loop:true,}},});$(window).on('resize',function(){})
var equipmentSlider=new Swiper('.equipment .swiper-container',{slidesPerView:1,loop:false,navigation:{nextEl:'.equipment .swiper-button-next',prevEl:'.equipment .swiper-button-prev',}});$(".col-insta-testim .text:contains('@naturel_studio')").each(function(indx,elem){var text=$(elem).html(),str='@naturel_studio',newtext=text.replace(str,'<a href="https://www.instagram.com/naturel_studio/" target="_blank">'+str+'</a>');$(elem).html(newtext);});$('.master_short_info').readmore({speed:500,collapsedHeight:84,embedCSS:false,moreLink:'<div class="btn_more_bl"><a href="" class="more"><span>'+lang[currentLang].more+'</span></a></div>',lessLink:'<div class="btn_more_bl"><a href="" class="more"><span>'+lang[currentLang].minimize+'</span></a></div>',beforeToggle:function(trigger,element,expanded){$(element).toggleClass('expanded');}});if(ww<768){$('.collapse_text_service').readmore({speed:500,collapsedHeight:345,embedCSS:false,moreLink:'<div class="btn_more_bl"><a href="" class="more"><span>'+lang[currentLang].readmore+'</span></a></div>',lessLink:'<div class="btn_more_bl"><a href="" class="more"><span>'+lang[currentLang].minimize+'</span></a></div>',beforeToggle:function(trigger,element,expanded){$(element).toggleClass('expanded');}});}
$('.collapse_text').readmore({speed:500,collapsedHeight:345,embedCSS:false,moreLink:'<div class="btn_more_bl"><a href="" class="more"><span>'+lang[currentLang].readmore+'</span></a></div>',lessLink:'<div class="btn_more_bl"><a href="" class="more"><span>'+lang[currentLang].minimize+'</span></a></div>',beforeToggle:function(trigger,element,expanded){$(element).toggleClass('expanded');}});$('.collapse_contacts_text').readmore({speed:500,collapsedHeight:145,embedCSS:false,moreLink:'<div class="btn_more_bl"><a href="" class="more"><span>'+lang[currentLang].readmore+'</span></a></div>',lessLink:'<div class="btn_more_bl"><a href="" class="more"><span>'+lang[currentLang].minimize+'</span></a></div>',beforeToggle:function(trigger,element,expanded){$(element).toggleClass('expanded');}});$('.tooltip').tooltipster({theme:'tooltipster-borderless',trigger:'custom',triggerOpen:{mouseenter:true,touchstart:true},triggerClose:{click:true,scroll:true,tap:true}});$(document).on('click','.sign_up',function(e){e.preventDefault();var $this=$(this);$.fancybox.open($('#signUp'),{touch:false,hash:'signUp',beforeShow:function(instance,current){$('#fieldMasterName, #fieldPosition, #fieldSalon').val('').trigger('refresh');$('#masterSignupInfo').html('');var name=$this.data('name'),position=$this.data('position'),salon=$this.data('salon');if(name!=''&&name!=undefined){$('#masterSignupInfo').html('<div class="name">'+name+'</div><div class="position">'+position+'</div>');$('#fieldMasterName').val(name);$('#fieldPosition').val(position);}
if(salon!=''&&salon!=undefined)
$('#fieldSalon').val(salon).trigger('change').trigger('refresh');},afterShow:function(instance,current){$('.popup select').styler();}});});if(window.location.hash){var thisHash=window.location.hash;if(thisHash=='#signUp'){$('.middle-head .sign_up').trigger('click');}}
$.mask.definitions['5']="[012345679]";$('input[name=phone]').mask('+7 (599) 999-99-99');$(document).on('click','.order_sert',function(e){e.preventDefault();var $this=$(this);$.fancybox.open($('#orderSert'),{touch:false,beforeShow:function(instance,current){$('#fieldSertTitle, #fieldSertPrice').val('').trigger('refresh');$('#sertOrderInfo').html('');var title=$this.data('title'),price=$this.data('price'),priceFormat=$this.data('price-format');if(title!=''&&title!=undefined){$('#sertOrderInfo').html('<div class="name">'+title+'</div><div class="position">'+priceFormat+'</div>');$('#fieldSertTitle').val(title);$('#fieldSertPrice').val(price);$('#payAmount, #payProductPrice').val(price+'.00');$('#payProductName').val('Сертификат '+title)}},afterShow:function(instance,current){}});});$(document).on('click','.btn_pay_online',function(e){e.preventDefault();var $this=$(this);$.fancybox.open($('#orderMC'),{touch:false,beforeShow:function(instance,current){$('#fieldMcTitle, #fieldMcPrice').val('').trigger('refresh');$('#mcOrderInfo').html('');var title=$this.data('title'),price=$this.data('price'),priceFormat=$this.data('price-format');if(title!=''&&title!=undefined){$('#mcOrderInfo').html('<div class="name">'+title+'</div><div class="position">'+priceFormat+'</div>');$('#fieldMcTitle').val(title);$('#fieldMcPrice').val(price);$('#payMcAmount, #payMcProductPrice').val(price+'.00');$('#payMcProductName').val('Мастер-класс '+title)}},afterShow:function(instance,current){$('.popup select').styler();}});});$('#fieldSalon').on('change',function(){var email_to=$(this).find(':selected').data('email');$('#fieldAddressTo').val(email_to);});$('#fieldMcPayment').on('change',function(){var val=$(this).val();$('.payment_text').eq(val-1).show().siblings().hide();})
$('.select_item select, .salon_select select').styler();$(document).on('mse2_load',function(e,data){if($('.select_item select').length>0){$('.select_item select').trigger('refresh');}
mastersOfSaloCarousel.update()});var apiKey='AIzaSyAuwXbk8HAKPMizn1RBJkvfgnnHLX8riqM';$('.youtube').each(function(indx,elem){var videoId=$(elem).data('videoid');$.ajax({url:"https://www.googleapis.com/youtube/v3/videos?id="+videoId+"&key="+apiKey+"&fields=items(snippet(title))&part=snippet",dataType:"jsonp",success:function(data){$(elem).find('.video_title').html(data.items[0].snippet.title);},error:function(jqXHR,textStatus,errorThrown){console.log(textStatus,+' | '+errorThrown);}});});$(".scroll_to").on('click',function(e){e.preventDefault();var dest=0;if($(this.hash).offset().top>$(document).height()-$(window).height()){dest=$(document).height()-$(window).height();}else{dest=$(this.hash).offset().top;}
$('html,body').animate({scrollTop:dest-50},1000,'swing');});$(window).on('hashchange load',function(){if(location.hash.indexOf('price_item')+1){$(location.hash).addClass('opened').find('.price_table_wrapper').slideDown(500);}});$(document).on('click','.works_link',function(e){e.preventDefault();$(this).closest('.master_item').find('.hgl:first-child').trigger('click');});var forEach=function(t,o,r){if("[object Object]"===Object.prototype.toString.call(t))for(var c in t)Object.prototype.hasOwnProperty.call(t,c)&&o.call(r,t[c],c,t);else for(var e=0,l=t.length;l>e;e++)o.call(r,t[e],e,t)};var hamburgers=document.querySelectorAll(".hamburger");if(hamburgers.length>0){forEach(hamburgers,function(hamburger){hamburger.addEventListener("click",function(){this.classList.toggle("is-active");},false);});}
$(".hamburger").on("click",function(){$(".mobile-nav").fadeToggle(600);$('.mobile_contacts').slideUp();});$('#salonSelect').on('change',function(){var salon_id=$(this).val();$('.mobile_contacts .item').hide();$('#mc'+salon_id).fadeIn(500);})
$(".footer-navs-mobile > ul > li").each(function(){if($(this).children('ul').length>0)
$(this).children("a").addClass("wdd")});$(".footer-navs-mobile ul li").on("click",".wdd",function(e){e.preventDefault();$(this).closest('li').toggleClass("opened").find("ul").slideToggle(600);});$("ul.services_list>li, ul.services_list>li>ul>li").on("click",function(e){e.stopPropagation();if(!$(e.target).hasClass('tooltip')){$(this).toggleClass("opened").children(".price_table_wrapper, ul").slideToggle(500);}});$("ul.services_list li p, .service_pricelist .price-table p").on("click",function(e){e.preventDefault();e.stopPropagation();$(this).toggleClass("opened").next(".mobile_pricelist").toggleClass("opened").slideToggle(500);});$('.m_link').on('click',function(e){e.preventDefault();$('.mobile_contacts').slideToggle();})
$('.acticle p').each(function(){if($('img',this).length==3)$(this).addClass('images_3');if($('img',this).length==2)$(this).addClass('images_2');})})